...
public class Main {
    ...
    public static int[][] mtd1(int[][] arr){
        int tmp = 0;
    ...
    public static int[][] mtd2(int[][] arr){
        int tmp = 0;
        for (int i = 0; i < n; i++) {
    ...
    public static int[][] mtd3(int[][] arr){
    ...
    public static int[][] mtd4(int[][] arr){
        int[][] result = new int[m][n];
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < m; j++) {
    ...
    public static int[][] mtd5(int[][] arr){
        int[][] result = new int[n][m];
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < m; j++) {
                if (i < (int)n/2 && j < (int)m/2) {
                    result[i][j+(int)m/2] = arr[i][j];
                }
                else if (i < (int)n/2 && j >= (int)m/2) {
                    result[i+(int)n/2][j] = arr[i][j];
                }
                else if (i >= (int)n/2 && j >= (int)m/2) {
                    result[i][j-(int)m/2] = arr[i][j];
                }
    ...
    public static int[][] mtd6(int[][] arr){
        int[][] result = new int[n][m];
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < m; j++) {
                if (i < (int)n/2 && j < (int)m/2) {
    ...
    public static void main(String[] args) throws IOException{
        ...
        st = new StringTokenizer(br.readLine());
        for (int i = 0; i < r; i++) {
            mtd = Integer.parseInt(st.nextToken());
            switch (mtd) {
                case 1:
                    arr = mtd1(arr);
                    break;
